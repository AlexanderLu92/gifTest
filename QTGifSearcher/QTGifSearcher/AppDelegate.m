...
- (void)setupWindow {
    ...
    QTTrendingGifsViewController *trendingViewController = [[QTTrendingGifsViewController alloc] initWithPresenter:presenter];

    self.window = [[UIWindow alloc] initWithFrame:[UIScreen mainScreen].bounds];
    self.window.rootViewController = [[UINavigationController alloc] initWithRootViewController:trendingViewController];
